...
import 'package:uts_kelompok6_kelas_a/models/surah.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:uts_kelompok6_kelas_a/screens/detail_screen.dart';
        ...
        children: [
          Stack(
            ...
            children: [
              ...
              SizedBox(height: 36, width: 36, child: Center(child: Text("${surah.nomor}", style: GoogleFonts.poppins(color: Colors.white, fontWeight: FontWeight.w500),)),
              )],
          ),
          ...
          Text(
            ...
            style: GoogleFonts.poppins(
              ...
              Row(children: [
                  ...
                  Container(width: 4, height: 4, decoration: BoxDecoration(borderRadius: BorderRadius.circular(2), color: text),
                  ),
                  const SizedBox(width: 5,),
                  Text(
          ...
          Text(
            surah.nama, 
            style: GoogleFonts.amiri(color: const Color(0xFFA44AFF), fontSize: 20, fontWeight: FontWeight.bold)),
        ],
      ),
    ),
  );
